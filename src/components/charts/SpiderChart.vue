              ...
              <ul class="py-2 font-medium" role="none">
                  ...
                  <li>
                      ...
                      >
                          ...
                          <div
                              class="inline-flex items-center text-primary text-md"
                          >
                              PNG
                          </div>
                      </div>
...
export default {
  ...
  methods: {
      createChart() {
          ...
          const label = this.categories;
          const hexColor = this.colors;
          const color = d3.scaleOrdinal().range(["#FFC837", "#6497B1"]);
          ...
          const margin = {
              top:
                  containerWidth > 1080 ? 80 : containerWidth > 640 ? 70 : 60,
              right:
                  containerWidth > 1080 ? 60 : containerWidth > 640 ? 50 : 30,
              bottom:
                  containerWidth > 1080 ? 70 : containerWidth > 640 ? 50 : 40,
              left:
                  containerWidth > 1080 ? 60 : containerWidth > 640 ? 50 : 30,
          };
          ...
          const config = {
              ...
              dotRadius: 4, //Ukuran titik lingkaran bercolors pada setiap blob
          ...
          var svg = d3
              ...
              .attr(
                  "width",
                  widthFix + config.margin.left + config.margin.right
              )
              .attr(
                  "height",
          ...
          //colors Latar Belakang Lingkaran
          axisGrid
              .selectAll(".levels")
          ...
          blobWrapper
              ...
              .attr("d", function (d) {
                  return radarLine(d.map(() => ({ value: 0 })));
              })
          ...
          blobWrapper
              ...
              .on("mouseover", function () {
                  if (d3.active(this)) {
                      return; // Mencegah Animasi Berhenti
                  }
