<template>
    <LayoutBaru
      :title="general.title + ' ' + dataGroupBarChartKor[indexDaerah].region"
    >
      <div class="w-full flex flex-col xl:flex-row gap-6">
        <div class="flex-col h-full w-full">
          ...
          <div class="w-full flex items-center justify-center">
            <div
              v-for="(item, index) in dataGroupBarChartKor[indexDaerah]
                .categories"
              :key="item"
              class="w-40"
            >
  ...
  import GroupBarChart from "../charts/Boxplot.vue";
  import { dataGroupBarChartKor, listVariabel, listDaerah } from "../../data/kor";
  ...
  export default {
    ...
    setup() {
      const title = "groupbarchart-kor-fix";
      const general = ref(dataGroupBarChartKor[0].anak[0]);
      ...
      watch(
        ...
        () => {
          switch (indexSelectedKategori.value) {
            case 0:
              general.value =
                dataGroupBarChartKor[indexDaerah.value].anak[indexVariabel.value];
            ...
            case 1:
              general.value =
                dataGroupBarChartKor[indexDaerah.value].dewasa[
                  indexVariabel.value
                ];
              data.value = general.value.data;
              colors.value = general.value.colors;
